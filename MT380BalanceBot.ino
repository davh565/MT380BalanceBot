...
#endif
//PID params
double pidBias = 0; //0: angle only, 1: speed only, 0.5: equal weight
    //Angle
...
double kI2 = 0.2;
double kD2 = 0.0;
double pidMax2 = 256; //Max PID value before saturation
//Motor params
#if MOTORTYPE
...
void loop(){
    ...
    // PID CONTROL BALANCE
    currentError1 = setPoint1+2*pidOut2/pidMax2 - angY;
    ...
    Serial.print(" pid2:");
    Serial.println(pidOut2/pidMax2);
    // Serial.print(" ER1:");
    // Serial.print(currentError1);
    // Serial.print(" ER2:");
    // Serial.print(currentError2);
    // Serial.print(" MTRSPD:");
    // Serial.println(LPFmotorAvSpeed);
    // Serial.print(" PIDang:");
    ...
    case RUN:
        ...
        //During Actions:
            ...
            setPoint2 =  myPotentiometer2.read()/972*25;
            //add actions above
